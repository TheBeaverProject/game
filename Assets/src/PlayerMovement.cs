...
public class PlayerMovement : MonoBehaviour
{
	...
	//Method to check if entity is grounded or blocked. TODO: Put it in the class entity
    public bool GroundedCheck(Transform groundCheck, float groundDistance, LayerMask groundMask)
    {
	    return Physics.CheckSphere(groundCheck.position, groundDistance, groundMask);
    }

    public bool RoofCheck(Transform roofcheck, float roofDistance, LayerMask groundMask)
    {
	    return Physics.CheckSphere(roofCheck.position, roofDistance, groundMask);
    }
    ...
    void Update()
    {
		...
		blocked = RoofCheck(roofCheck, roofDistance, groundMask);
		isGrounded = GroundedCheck(groundCheck, groundDistance, groundMask);
